// // src/app/_components/ProjectSection.tsx
...
//   <div className={`flex flex-col md:flex-row w-full mt-10 ${reverse ? 'md:flex-row-reverse' : ''} px-4 md:px-8`}>
//     {/* Text Section */}
//     <div className="md:w-1/2 text-right md:text-left flex flex-col justify-center mb-8 md:mb-0">
//       <h3 className="text-[#f4b6c2] font-medium md:text-4xl text-2xl text-center md:text-left mb-3">
//         {title}
//       </h3>
//       <p className="text-justify text-white mb-4 px-0 md:px-2">
//         {description}
//         <br />
//         <span className="text-[#f4b6c2]"> (Using):</span>
//       </p>
//       <ul className="list-none flex flex-row gap-3 pt-3 md:text-sm text-xs font-medium justify-center md:justify-start px-0 md:px-2">
...
//           blurDataURL="data:..."
//           placeholder="blur"
//           className="relative w-[300px] h-[200px] sm:w-[360px] sm:h-[240px] md:w-[370px] md:h-[230px] lg:w-[370px] lg:h-[230px] z-10 mt-6" // Higher z-index to appear above the button
//         />
//       </Link>
//     </div>
//   </div>
...
const ProjectSection: React.FC<ProjectSectionProps> = ({ title, description, imageSrc, link, reverse }) => (
  <div className={`flex flex-col md:flex-row w-full mt-20 ${reverse ? 'md:flex-row-reverse' : ''}`}>
    ...
    <div className="md:w-1/2 text-right md:text-left flex flex-col justify-center">
      ...
      <p className="text-justify mt-2 text-white mb-4">
        {description}
        <br />
        <span className="text-[#f4b6c2]"> (Using):</span>
      </p>
