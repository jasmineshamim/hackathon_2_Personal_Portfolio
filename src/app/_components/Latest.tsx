...
const LatestSection = () => {
  ...
  return (
    <>
      <section className="max-w-screen-xl mx-auto px-4 relative h-full mb-16">
        <div className="text-[#2abecc] w-auto h-auto p-5 flex flex-col justify-center items-center mt-10">
          <div className="text-4xl font-semibold border-b-2 border-[#2abecc] p-4">
            <h2 className="bg-[#111] relative z-10">Latest Works</h2>
          </div>
