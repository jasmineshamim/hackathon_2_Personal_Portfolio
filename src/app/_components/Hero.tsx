  ...
  return (
    <div className='text-white max-w-screen-2xl mx-auto relative'>
      <div className='flex flex-col h-screen justify-center items-center'>
        ...
        {/* Main Content */}
        <div className='flex flex-col items-start -mt-44 relative px-7 md:mr-96'>
          ...
          <p className="mt-2 font-medium font-[Spartan] text-4xl md:text-4xl text-1xl
            ">
            And I' m a <span className="md:font-extrabold font-bold font-['Merriweather'] text-[#7cdee6] italic md:text-4xl text-2xl"><span ref={typedRef}></span></span>
          </p>
